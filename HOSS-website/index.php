    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
                <iframe class="w-100 rounded" src="<?php echo $contact_r['iframe'] ?>" height="320px" allowfullscreen=""
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="bg-white p-4 rounded mb-4">
                    ...
                    <br>
                    <a href="<?php echo $contact_r['whats'] ?>" class="d-inline-block mb-3" target="_blank">
                        <span class="badge bg-light text-dark fs-6 p-2">
                    ...
                    if ($contact_r['insta']!= '') {
                        echo <<<data
                        <a href="$contact_r[insta]" class="d-inline-block" target="_blank">
                            <span class="badge bg-light text-dark fs-6 p-2">
